---
title:
  "Hoe maak ik de Digitale Overheid beter? Spoiler: draag bij aan Open Source
  projecten."
description:
...
me een vraag waar ik afgelopen jaar sowieso veel op gekauwd heb:

"Aannemende dat ik mijn werkdag start met mijn ultieme doel: de digitale
overheid beter te maken, moet ik mezelf de vraag stellen: hoe doe ik dat? Waar
is die overheid mee geholpen?"

Een inzicht die ik opdeed uit de podcast van de Foundation voor Publiccode biedt
hier denk ik puzzelstukje om tot een antwoord te komen. (helaas
gediscontinueerd) De wijsheid luidt als volgt: software is kennis. Het bevat
praktijkkennis die over de jaren vergaard is en vertegenwoordig en belichaamd
deze.

> Software is kennis. Het bevat praktijkkennis die over de jaren vergaard is en
> vertegenwoordig en belichaamd deze.
...
# Manier 1; draag bij aan een proven OS component
...
## Open source componenten, als paard van troje voor convergentie en kwaliteit
...
## Manier 2; organiseer kennisdeling in mijn organisatie
